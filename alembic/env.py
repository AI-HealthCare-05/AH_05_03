...
from app.models import FamilyInvitation, User  # noqa: F401
...
async def run_async_migrations() -> None:
    engine = async_engine_from_config(
        alembic_config.get_section(alembic_config.config_ini_section, {}), prefix="sqlalchemy.", poolclass=pool.NullPool
    )
