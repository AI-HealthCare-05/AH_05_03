  ...
  return (
    <>
      <div className="floating-health-tools">
        <button type="button" onClick={() => setOcrOpen(true)}>건강 서류 가져오기</button>
      </div>
      {ocrOpen ? (
        <DocumentOcrDialog
          profile={profile}
