...
import "../styles/ui-preview15.css";
...
export function UiPreview15Page() {
  ...
  return (
    <div className="up15-root">
      {/* 13가지 레이아웃 비교 바 */}
      {isPreview ? <VariantBar current="v15" /> : null}
            ...
            <article className="up15-card">
              <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "space-between", alignItems: "center", paddingBottom: "14px", borderBottom: "1px solid var(--up15-ash)", gap: "10px" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                  <div style={{ display: "flex", background: "var(--up15-bone)", borderRadius: "100px", padding: "3px", border: "1px solid var(--up15-ash)" }}>
                    <button type="button" className="up15-nav-btn active" style={{ padding: "4px 12px", fontSize: "11px" }}>
                      기록 기반
                    </button>
                    <button type="button" className="up15-nav-btn" style={{ padding: "4px 12px", fontSize: "11px" }} onClick={() => void navigate("/assessment")}>
                      예측 뷰
                    </button>
                  </div>
                  <div style={{ display: "flex", alignItems: "center", background: "var(--up15-bone)", borderRadius: "100px", padding: "4px 12px", border: "1px solid var(--up15-ash)", fontSize: "11px" }}>
                    <span>오늘</span>
                  </div>
                </div>
              </div>
              ...
              <div style={{ overflowX: "auto" }}>
                <table className="up15-timeline-table">
                  <thead>
                    <tr>
                      <th style={{ textAlign: "left", width: "120px" }}>구성원</th>
                      <th>09-09</th>
                      <th>09-10</th>
                      <th>09-11</th>
                      <th>09-12</th>
                      <th>09-13</th>
                      <th>09-14</th>
                      <th style={{ color: "var(--up15-aubergine)", background: "rgba(226, 223, 254, 0.35)", borderRadius: "10px 10px 0 0", fontWeight: 500 }}>09-15 (오늘)</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      ...
                      <td><span className="up15-timeline-pill lavender">혈압 120</span></td>
                      <td><span className="up15-timeline-pill bone">어깨 1</span></td>
                      <td><span className="up15-timeline-pill blush">혈압주의</span></td>
                      <td><span className="up15-timeline-pill butter">명치 2</span></td>
                      <td><span className="up15-timeline-pill lavender">혈압 128</span></td>
                      <td><span className="up15-timeline-pill bone">정상</span></td>
                      <td style={{ background: "rgba(226, 223, 254, 0.35)" }}>
                    ...
                    <tr>
                      ...
                      <td><span className="up15-timeline-pill bone">혈당 98</span></td>
                      <td><span className="up15-timeline-pill lavender">검진 서류</span></td>
                      <td><span className="up15-timeline-pill butter">편두통 2</span></td>
                      <td><span className="up15-timeline-pill blush">혈당 118</span></td>
                      <td><span className="up15-timeline-pill bone">정상</span></td>
                      <td><span className="up15-timeline-pill lavender">식후 124</span></td>
                      <td style={{ background: "rgba(226, 223, 254, 0.35)" }}>
                        <span className="up15-timeline-pill bone" style={{ background: "#fff" }}>양호</span>
                      </td>
                    </tr>
                    <tr>
                      <td style={{ textAlign: "left", color: "var(--up15-obsidian)" }}>오민재 (동생)</td>
                      <td><span style={{ color: "var(--up15-fog)" }}>-</span></td>
                      <td><span className="up15-timeline-pill bone">체온 36.5°</span></td>
                      <td><span style={{ color: "var(--up15-fog)" }}>-</span></td>
                      <td><span className="up15-timeline-pill lavender">운동 완료</span></td>
                      <td><span style={{ color: "var(--up15-fog)" }}>-</span></td>
                      <td><span className="up15-timeline-pill bone">줄넘기</span></td>
                      <td style={{ background: "rgba(226, 223, 254, 0.35)" }}>
                        <span className="up15-timeline-pill bone" style={{ background: "#fff" }}>정상</span>
                      </td>
                    </tr>
                  </tbody>
                </table>
...
export default UiPreview15Page;
