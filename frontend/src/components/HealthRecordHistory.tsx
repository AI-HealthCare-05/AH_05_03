...
const labels: Record<string, string> = { blood_pressure: "혈압", blood_glucose: "혈당", body_measurement: "체성분", lab_result: "검사 수치", vaccination: "예방접종", health_screening: "건강검진", pain: "통증", walking: "걷기", note: "기타 기록" };
