...
class JwtService:
    ...
    def create_access_token(self, user: ServiceAccount) -> AccessToken:
        return self.access_token_class.for_user(user)

    def create_refresh_token(self, user: ServiceAccount) -> RefreshToken:
    ...
    def issue_jwt_pair(self, user: ServiceAccount) -> dict[str, AccessToken | RefreshToken]:
