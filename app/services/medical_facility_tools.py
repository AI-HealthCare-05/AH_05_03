...
FACILITY_TOOL_DECLARATIONS = [
    types.FunctionDeclaration(
        ...
        description=(
            ...
            "절대 날씨, 대기질, 식단, 운동, 일반 대화에서는 이 도구를 호출하지 마세요. "
            "사용자가 응급실을 직접 찾거나 응급 진료를 요청했을 때만 호출하세요. "
    ...
    types.FunctionDeclaration(
        ...
        description=(
            ...
            "절대 날씨, 대기질, 식단, 운동, 일반 대화에서는 이 도구를 호출하지 마세요. "
            "사용자가 병원·의원을 직접 찾거나 진료과목을 지정하여 병원 안내를 요청했을 때만 호출하세요. "
    ...
    types.FunctionDeclaration(
        ...
        description=(
            ...
            "절대 날씨, 대기질, 식단, 운동, 일반 대화에서는 이 도구를 호출하지 마세요. "
            "사용자가 약국을 직접 찾거나 약국 안내를 요청했을 때만 호출하세요. "
